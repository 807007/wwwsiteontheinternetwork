...
Explanation: <br>
&nbsp;&nbsp;&nbsp;Line 1: <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;As LLMs generate text 1 token at a time, having it lay out instructions for itself should create <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;a more structured response, since it'll refer to these instructions throughout its response. <br>
&nbsp;&nbsp;&nbsp;Line 2: <br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;As you can tell, I'm still trying to get it to rely less on external sources. It is indeed that <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;big a problem. <br>
&nbsp;&nbsp;&nbsp;Line 6: <br>
